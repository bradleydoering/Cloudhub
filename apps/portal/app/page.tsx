...
function InvoiceManager() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'paid': return 'bg-navy/20 text-navy border-navy/30';
      case 'pending': return 'bg-coral/20 text-coral border-coral/30';
      case 'overdue': return 'bg-coral/30 text-coral border-coral/50';
      case 'upcoming': return 'bg-navy/10 text-navy border-navy/20';
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-navy/5 border border-navy/20 rounded-lg p-6 [clip-path:polygon(1rem_0%,100%_0%,100%_calc(100%-1rem),calc(100%-1rem)_100%,0%_100%,0%_1rem)]">
          <h3 className="font-space text-lg font-medium text-navy mb-2">Paid</h3>
          <div className="text-2xl font-bold text-navy">${totalPaid.toLocaleString()}</div>
        </div>
        <div className="bg-coral/5 border border-coral/20 rounded-lg p-6 [clip-path:polygon(1rem_0%,100%_0%,100%_calc(100%-1rem),calc(100%-1rem)_100%,0%_100%,0%_1rem)]">
          <h3 className="font-space text-lg font-medium text-coral mb-2">Remaining</h3>
          <div className="text-2xl font-bold text-coral">${(totalProject - totalPaid).toLocaleString()}</div>
        </div>
      </div>
        ...
        <div>
          ...
          <div className="space-y-4">
            {pendingPayments.map((invoice) => (
              <div key={invoice.id} className="bg-coral/5 border border-coral/20 rounded-lg p-6 [clip-path:polygon(1rem_0%,100%_0%,100%_calc(100%-1rem),calc(100%-1rem)_100%,0%_100%,0%_1rem)]">
        ...
        <div>
          ...
          <div className="space-y-4">
            {invoices.filter(inv => inv.status === 'upcoming').map((invoice) => (
              <div key={invoice.id} className="bg-navy/5 border border-navy/20 rounded-lg p-4 [clip-path:polygon(0.5rem_0%,100%_0%,100%_calc(100%-0.5rem),calc(100%-0.5rem)_100%,0%_100%,0%_0.5rem)]">
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    <h4 className="font-medium text-navy mb-1">{invoice.title}</h4>
                    <p className="text-sm text-muted-foreground mb-2">{invoice.description}</p>
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        {filteredPhotos.map((photo) => (
          ...
          >
            <div className="aspect-square bg-navy/20 rounded-lg overflow-hidden [clip-path:polygon(0.5rem_0%,100%_0%,100%_calc(100%-0.5rem),calc(100%-0.5rem)_100%,0%_100%,0%_0.5rem)]">
              <img
                src={photo.src}
                alt={photo.title}
...
function ChangeOrderManager() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'approved': return 'bg-navy/20 text-navy border-navy/30';
      case 'pending': return 'bg-coral/20 text-coral border-coral/30';
      case 'rejected': return 'bg-coral/30 text-coral border-coral/50';
      default: return 'bg-navy/10 text-navy border-navy/20';
    }
  };
  ...
  return (
    <div className="space-y-8">
        ...
        <div>
          ...
          <div className="space-y-4">
            {pendingOrders.map((order) => (
              <div key={order.id} className="bg-coral/5 border border-coral/20 rounded-lg p-6 [clip-path:polygon(1rem_0%,100%_0%,100%_calc(100%-1rem),calc(100%-1rem)_100%,0%_100%,0%_1rem)]">
                <div className="flex justify-between items-start mb-4">
                  <div>
                ...
                <div className="flex gap-3">
                  ...
                  <Button
                    ...
                    className="border-coral/30 text-coral hover:bg-coral/5 px-6"
                  >
                    ✗ Reject
                  </Button>
                  <Button
      ...
      {/* Summary */}
      <div className="bg-navy/5 rounded-lg p-6 [clip-path:polygon(1rem_0%,100%_0%,100%_calc(100%-1rem),calc(100%-1rem)_100%,0%_100%,0%_1rem)]">
...
function DocumentViewer() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'signed': case 'approved': case 'paid': return 'bg-navy/20 text-navy';
      case 'current': return 'bg-navy/10 text-navy';
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="flex-1">
          <input
            ...
            className="w-full px-4 py-2 border border-navy/20 rounded-lg focus:ring-2 focus:ring-coral focus:border-coral"
          />
        </div>
        <div className="flex gap-2 overflow-x-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {filteredDocuments.map((doc) => (
          <div key={doc.id} className="bg-navy/5 rounded-lg p-4 hover:bg-navy/10 transition-colors">
...
export default function Home() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'completed': return 'bg-navy/20 text-navy border-green-300';
      case 'in-progress': return 'bg-coral text-white border-coral';
      case 'pending': return 'bg-navy/10 text-navy border-navy/20';
      default: return 'bg-navy/10 text-navy border-navy/20';
    }
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div>
              ...
              <div className="space-y-2">
                ...
                <div className="w-full bg-navy/20 rounded-full h-2">
              ...
              <button
                ...
                className={`py-4 px-1 border-b-2 font-medium text-sm transition-colors ${
                  activeTab === tab.id
                    ...
                    : 'border-transparent text-muted-foreground hover:text-foreground hover:border-navy/20'
                }`}
              >
                {tab.icon} {tab.name}
              </button>
                  ...
                  {projectPhases.map((phase, index) => (
                    <div key={phase.id} className="flex items-center space-x-4">
                      <div className={`w-3 h-3 rounded-full flex-shrink-0 ${
                        phase.status === 'completed' ? 'bg-navy' :
                        phase.status === 'in-progress' ? 'bg-coral' : 'bg-navy/30'
                      }`}></div>
                      <div className="flex-1">
                        ...
                        <div className="w-full bg-navy/20 rounded-full h-1.5 mt-2">
                          <div 
                            className={`h-1.5 rounded-full ${
                              phase.status === 'completed' ? 'bg-navy' :
                              phase.status === 'in-progress' ? 'bg-coral-gradient' : 'bg-navy/30'
                            }`}
              ...
              <div>
                ...
                <div className="space-y-4">
                  {recentActivity.map((activity) => (
                    <div key={activity.id} className="flex items-start space-x-4 p-4 bg-navy/5 rounded-lg">
